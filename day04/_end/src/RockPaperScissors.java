...
public class RockPaperScissors {
    ...
    /**
     * @return "draw", "win" (player wins) or "lose" (player loses), from the player's point of view.
     */
    public static String determineOutcome(int playerChoice, int computerChoice) {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Determine winner
            String outcome = determineOutcome(playerChoice, computerChoice);
