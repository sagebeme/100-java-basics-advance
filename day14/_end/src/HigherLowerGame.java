...
public class HigherLowerGame {
    ...
    /**
     * @return true if the guess ("A" or "B") correctly names the person with more followers.
     */
    public static boolean isCorrectGuess(String guess, int valueA, int valueB) {
        if (guess.equals("A") && valueA > valueB) {
            return true;
        }
        return guess.equals("B") && valueB > valueA;
    }
    ...
    public static void main(String[] args) {
        ...
        while (!gameOver) {
            ...
            if (isCorrectGuess(guess, valueA, valueB)) {
                score++;
